...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cbuf9ht6rf7t.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstones3andrewblog' # please enter your s3 bucket name
